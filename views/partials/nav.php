            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="<?php echo urlIs("/") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white"; ?> rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                        ...
                        <a href="/notes" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
                        <?php endif; ?>
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else: ?>
                                ...
                                <a href="/login" class="<?php echo urlIs("/login") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white"; ?> rounded-md px-3 py-2 text-sm font-medium">Login</a>
                            <?php endif; ?>
                        </div>
                        <!--
                    ...
                    <?php if ($_SESSION['user'] ?? false): ?>
                        <div class="relative ml-10">
                            <form action="/session" method="POST">
                                ...
                                <button type="submit" class="rounded-md bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Logout</button>
                            </form>
                        </div>
                    <?php endif; ?>
